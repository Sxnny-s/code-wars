...
function sumOrProduct(array, n) {
    ...
    smallest = array.slice(0, n)

    array.sort((a,b) => b - a)

    array

    largest = array.slice(0,n)

    largest

   let product = smallest.reduce((a,c) => a * c )

   product

   let sum = largest.reduce((a,c) => a + c )
  ...
  const x = [1, 4, 2, 3, 5, 6, 7, 8, 9, 10]
  const y = [4]
//   answer "sum"

  console.log(sumOrProduct(x,y))